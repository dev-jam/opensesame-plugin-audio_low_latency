...
class AudioLowLatencyRecordPause(Item):
...
class QtAudioLowLatencyRecordPause(AudioLowLatencyRecordPause, QtAutoPlugin):

    def __init__(self, name, experiment, script=None):
        AudioLowLatencyRecordPause.__init__(self, name, experiment, script)
